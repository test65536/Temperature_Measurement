...
ser = serial.Serial('/dev/ttyUSB0', baudrate=115200, bytesize=8, timeout=0.375)  # 连接串口
db = pymysql.connect("localhost", "root", "password", "test")  # 连接数据库zong
...
# rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
        ...
        if new_old == 'N':
            ...
            while True:
                ...
                if (len(read_sleep_time_data) < 7 or
                        (read_sleep_time_data[0] == 247 and read_sleep_time_data[1] == 255)):
